        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    {
                        string query1 = "INSERT INTO product(description, purchase_price, store_price, inc, cur_price, stock_in, stock_out, tot_quantity, cost_quantity, category_cat_id, unit_unit_id) VALUES('" + desc.Text + "' , 0, 0, 0, 0, 0, 0, 0, 0, (SELECT cat_id FROM category WHERE name='" + categ.Text + "'), (SELECT unit_id FROM unit WHERE name='" + unit.Text + "'));";
